...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"Coloque o título\" value=\"" +
    marko_escapeXmlAttr(data.livro.titulo) +
    "\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"00.00\" value=\"" +
